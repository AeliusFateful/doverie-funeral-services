export const siteConfig = {
  ...
  description:
    "Похоронное служба «Доверие» в Кемерово. Круглосуточный выезд агента за 15-30 минут. Организация похорон, оформление документов, вызов ритуального агента, кремация, памятники и ритуальные товары. Похоронное бюро полного цикла.",
  url:
