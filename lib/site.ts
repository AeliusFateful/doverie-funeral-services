export const siteConfig = {
  ...
  inn: "420552528499",
  title: "Ритуальные услуги в Кемерово - похоронная служба под ключ, круглосуточно",
  description:
    "Бесплатный выезд агента за 15-30 минут 24/7. Организация похорон, оформление документов, вызов ритуального агента, кремация, памятники и ритуальные товары. Похоронное бюро полного цикла.",
