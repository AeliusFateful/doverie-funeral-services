        ...
        <div className="mt-10 space-y-8 text-base leading-relaxed text-muted-foreground">
          <section>
            ...
            <p className="mt-3">
              ...
              Федеральным законом № 152-ФЗ «О персональных данных» и иными
              нормативными актами Российской Федерации.
            </p>
            <p className="mt-3">
              Условия обработки данных, собираемых системами веб-аналитики
              (Яндекс.Метрика, Google Analytics), подробно описаны в{" "}
              <Link
                href="/consent"
          ...
          <section>
            ...
            <ul className="mt-3 list-inside list-disc space-y-2">
              <li>
                номер телефона — при звонке или обращении через мессенджеры;
              </li>
              <li>
                имя и контактные данные — при обращении через WhatsApp, Telegram
                или ВКонтакте;
              </li>
              <li>
                технические данные: IP-адрес, тип браузера, данные cookie,
                информация об устройстве и посещённых страницах — в том числе
                собираемые с помощью систем веб-аналитики Яндекс.Метрика и
                Google Analytics.
              </li>
            </ul>
            <p className="mt-3">
              Сайт не содержит форм сбора персональных данных. Обращение через
              телефон или мессенджеры происходит по инициативе пользователя.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 list-inside list-disc space-y-2">
              ...
              <li>
                консультация по организации похорон и сопутствующих услуг;
              </li>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              Российской Федерации, или когда передача необходима для исполнения
              договора (например, оформление документов в государственных
              органах).
            </p>
            <p className="mt-3">
              На Сайте могут использоваться сторонние сервисы: карты 2ГИС, а
              также системы веб-аналитики Яндекс.Метрика (Яндекс) и Google
              Analytics (Google), которые обрабатывают данные в соответствии с
          ...
          <section>
            ...
            <p className="mt-3">
              Персональные данные хранятся на защищённых серверах и
              обрабатываются с применением организационных и технических мер,
              обеспечивающих их безопасность. Срок хранения определяется целями
              обработки и требованиями законодательства.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              работы (например, сохранение предпочтений темы оформления) и сбора
              аналитических данных, в том числе с помощью Яндекс.Метрики и
              Google Analytics. Вы можете ограничить использование cookie в
              настройках браузера. Подробнее — в{" "}
              <Link
                href="/consent"
                className="text-foreground underline underline-offset-4 hover:text-accent"
              >
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              всегда доступна на данной странице. Продолжение использования
              Сайта после внесения изменений означает согласие с обновлённой
              Политикой.
            </p>
          </section>
