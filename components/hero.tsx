...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-linear-to-r from-background via-background/85 to-background/30 lg:to-transparent" />
      ...
      <div className="relative mx-auto flex flex-col justify-center gap-8 min-h-dvh w-full max-w-site px-5 pt-28 pb-10 md:px-8 md:pb-12">
        ...
        <div className="z-10 mx-auto max-w-4xl text-center hidden lg:block mt-auto">
